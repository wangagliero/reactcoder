let productos = [
   ...
   { id: '3', categoria: 'tierra', name: 'bulbasar', price:'200', foto: 'https://static.wikia.nocookie.net/videojuego/images/4/43/Bulbasaur.png/revision/latest?cb=20110113231911'},
